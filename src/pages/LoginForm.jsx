...
function LoginForm() {
  ...
  const handleSocialAuth = (provider) => {
    // Redirect or execute social OAuth integration logic here
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-xs font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 active:scale-[0.98] dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-750"
                >
