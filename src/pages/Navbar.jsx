        ...
        >
          ...
          <ul className="flex flex-col gap-2 font-medium text-gray-600 dark:text-gray-300 md:flex-row md:items-center md:gap-6">
            ...
            <li>
              <Link
                to="/cart"
                className="relative inline-flex items-center gap-2 rounded-md px-3 py-2 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white md:p-0 md:hover:bg-transparent dark:md:hover:bg-transparent"
              >
